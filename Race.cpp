...
Race::Race(const std::string& name, const std::string& racename, const std::string& description)
    : Character(name), racename(racename), description(description) {}
...
void Race::initializeAvailableRaces() {
    ...
    Race humans("Игрок", "Humans", "Люди - самая разнообразная и адаптивная раса,"
    ...
    Race elves("Игрок", "Elves", "Эльфы - изящные и грациозные существа, живут в гармонии с природой и обладают выдающимся долголетием."
    ...
    Race dragonborns("Игрок", "Dragonborns", "Драконорожденные - удивительные существа, обладающие уникальным внешним видом, напоминающим их предков - драконов:"
    ...
    Race dwarves("Игрок", "Dwarves", "Дварфы - крепкая и выносливая раса, известная своими густыми бородами, низким ростом и умением создавать прекрасные изделия из"
    ...
    Race orcs("Игрок", "Orcs", "Орки - сильная и воинственная раса, известная своей агрессивностью и боеспособностью. Орки обычно имеют высокий рост, кожу от"
